...
class PaisAdapter (
    ...
    val onClick: (Pais) -> Unit
        ...
        class PaisViewHolder(view: View) : RecyclerView.ViewHolder(view) {
            ...
            init {
                ...
                cardView = view.findViewById(R.id.cardPaises)
            }
    ...
    override fun onBindViewHolder(holder: PaisViewHolder, position: Int) {
        ...
        Picasso.with(holder.itemView.context).load(pais.bandeira).fit().into(holder.cardImage, object: com.squareup.picasso.Callback {
